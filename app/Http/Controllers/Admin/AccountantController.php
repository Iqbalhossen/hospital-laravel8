...
class AccountantController extends Controller
{
    ...
    public function add()
    {
        return view('admin.accountant.add_compounder');
    }
    ...
    public function list()
    {
        ...
        //     ->get();
        $compounderIds = User::where('role', 'accountant')->pluck('id');
        ...
        return view('admin.accountant.list_compounder', ['doctors' => $doctors]);
    }

    public function paymentList()
    {
        $lists = User::select('id', 'name', 'email', 'rfid', 'phone')->where('role', 'patient')->get();
        return view('admin.accountant.payment_list', ['lists' => $lists]);
    }
    ...
    public function edit($id, $uid)
    {
        ...
        return view('admin.accountant.compounder_edit_form', compact('id', 'uid', 'doctor'));
    }
