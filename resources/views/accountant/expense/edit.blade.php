                  ...
                  <div class="card-body">
                    ...
                    <form method="post" action="{{route('expense.update',$expense->id)}}">
                        ...
                        <div class="col-sm-6">
                          <select name="expense_type_id" id="" class="form-control">
                              @foreach($types as $type)
                                <option {{$type->id==$expense->expense_type_id?'selected':''}} value="{{$type->id}}">{{$type->name}}</option>
                              @endforeach
                          </select>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input  id="title" type="text" class="form-control" name="title" value="{{$expense->title}}"/>
                          @if ($errors->has('title'))
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea  name="description" id="" class="form-control">{{$expense->description}}</textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input required id="amount" type="number" class="form-control" name="amount" value="{{$expense->amount}}"/>
