                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="dropdown float-right">
                            <a href="{{URL::to('/admin/employee/list')}}" class="btn btn-success">Employee List</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    <form method="post" action="{{URL::to('/admin/employee/edit-store')}}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input
                                 type="number" value="{{$doctor->salary}}" class="form-control" name="salary"/>
                        </div>
                      </div>
                    <div class="form-group row">
