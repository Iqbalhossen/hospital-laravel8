                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="dropdown float-right">
                            <a href="{{'/employee/doctor/list'}}" class="btn btn-success">Doctor List</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    <form method="post" action="/employee/doctor/edit-store">
                      {{ csrf_field() }}
                          ...
                          <select class="custom-select" name="specialist_id">
                            <option selected disabled value="0">Select Specialist</option>
                              @foreach($specialist as $list)
                                <option
                                  value={{$list->id}}
                                  {{($doctor->specialist_id == $list->id)? 'selected':''}} >
                                  {{$list->name}}
                                </option>
                              @endforeach
                          </select>
