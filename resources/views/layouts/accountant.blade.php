                  ...
                  <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column"
                        ...
                        data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{URL::to('/accountant/home')}}" class="nav-link ">
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{URL::to('/accountant/appointment/list')}}" class="nav-link ">
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('mobile-agent-type.index')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Mobile Agent Type</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('mobile-agent.index')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{URL::to('/accountant/requisition/list')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{URL::to('/accountant/expense-type/create')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Add Expense Type</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('/accountant/expense-type')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{URL::to('/accountant/expense/create')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Add Expense </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('/accountant/expense')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Expense  List</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{URL::to('accountant/report/expense')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Expense Report </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('accountant/report/appointment-pay')}}" class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Payment Report</p>
                                        </a>
                                    </li>
