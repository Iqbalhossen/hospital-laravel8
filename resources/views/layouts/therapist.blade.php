                  ...
                  <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column"
                        ...
                        data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{URL::to('/therapist/home')}}" class="nav-link active">
                            ...
                            <li class="nav-item menu-open">
                                <a href="{{URL::to('/therapist/specialist/add')}}" class="nav-link">
                                    <i class="nav-icon fas fa-calendar-check"></i>
                                    <p>Appointments<i class="right fas fa-angle-left"></i></p>
                                </a>
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{URL::to('/therapist/appointment/list')}}" class="nav-link active">
