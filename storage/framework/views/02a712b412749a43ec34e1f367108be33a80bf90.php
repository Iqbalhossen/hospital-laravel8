                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <th>
                            ...
                            <br>
                            <?php echo e($status->created_at->format('d-m-y h:i a')); ?>
                 ...
                 <tbody>
                     ...
                     <tr>
                       ...
                       <th>
                         ...
                         <br>
                            <?php echo e($assign->created_at->format('d-m-y h:i a')); ?>
                     ...
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                            <form action="<?php echo e(route('task.assign',$task->id)); ?>">
                                <th>
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/employee/task/show.blade.php ENDPATH**/ ?>