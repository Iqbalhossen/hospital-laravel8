          ...
          <div class="col-md-12">
              <div class="card">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="dropdown float-right">
                            <a href="<?php echo e('/admin/coordinator/list'); ?>" class="btn btn-success">Coordinator List</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(URL::to('/admin/coordinator/add')); ?>">
                      <?php echo e(csrf_field()); ?>

                      <input type="number" name="patient_id" value=<?php echo e(auth()->user()->id); ?> hidden />
                      <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">Coordinator Name*</label>
                        <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/admin/compounder/add_compounder.blade.php ENDPATH**/ ?>