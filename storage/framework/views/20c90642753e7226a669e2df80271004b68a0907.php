                            ...
                            <tbody>
                                <?php $__currentLoopData = $leaveApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($application->user->name ?? null); ?> (<?php echo e($application->user->id ?? null); ?>)
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <?php if($application->status == 0): ?>
                                                    <a href="<?php echo e(route('leave.approve', $application->id)); ?>"
                                                        class="btn btn-success btn-sm">Approve</a>
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('leave.show', $application->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/admin/leave/index.blade.php ENDPATH**/ ?>