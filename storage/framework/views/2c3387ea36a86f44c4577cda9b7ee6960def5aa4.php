                            ...
                            <tbody>
                                <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <th>
                                            <?php echo e($appointment->appoint_at); ?>
                                        ...
                                        <td>
                                            <a class="btn btn-info"
                                                href="<?php echo e(route('therapist.appointment.show', $appointment->id)); ?>">View</a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.therapist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/therapist/appointment/index.blade.php ENDPATH**/ ?>