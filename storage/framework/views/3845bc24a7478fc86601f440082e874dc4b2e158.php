                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(Carbon\Carbon::parse($appointment->appoint_at)->format('d-m-y')); ?>
                            ...
                            <br>
                            <?php echo e($appointment->slot?$appointment->slot->slot->start.'-'.$appointment->slot->slot->end:''); ?>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('doctor.therapy.history',$therapy->id)); ?>" class="btn btn-sm btn-info">View</a>
                            </td>
                            </td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/doctor/appointment/show.blade.php ENDPATH**/ ?>