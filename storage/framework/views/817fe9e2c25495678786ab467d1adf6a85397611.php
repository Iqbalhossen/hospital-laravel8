                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="dropdown float-right">
                            <a href="<?php echo e('/accountant/expense'); ?>" class="btn btn-success">Expense List</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(route('expense.store')); ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input required id="amount" type="number" class="form-control" name="amount" value="<?php echo e(old('amount')); ?>"/>
...
<?php echo $__env->make('layouts.'.auth()->user()->role, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/accountant/expense/create.blade.php ENDPATH**/ ?>