          ...
          <div class="col-md-12">
              <div class="card">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="dropdown float-right">
                            <a href="<?php echo e(URL::to('/admin/employee/list')); ?>" class="btn btn-success">Employee List</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(URL::to('/admin/employee/add')); ?>" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        <label for="nid" class="col-sm-2 col-form-label">Salary</label>
                        <div class="col-sm-6">
                            <input
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/admin/emp/add_compounder.blade.php ENDPATH**/ ?>