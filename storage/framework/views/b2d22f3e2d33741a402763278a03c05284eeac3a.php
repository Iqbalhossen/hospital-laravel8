                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($therapyAmount+($appointment->doctor?$appointment->doctor->doctor->visit:0)-$appointment->given); ?>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('appointment.therapy.history',$therapy->id)); ?>" class="btn btn-sm btn-info">View</a>
                                </td>
                                </td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.compounder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suoxuahd/public_html/resources/views/therapist/appointment/show.blade.php ENDPATH**/ ?>